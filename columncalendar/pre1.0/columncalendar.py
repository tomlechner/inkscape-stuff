...
class ColumnCalendar (inkex.Effect):
    ...
    def __init__(self):
        ...
        self.OptionParser.add_option("--tab",
          ...
          dest="tab")
        self.OptionParser.add_option("--week-width",
          action="store", type="string",
    ...
    def calculate_size_and_styles(self):
        ...
        self.options.week_width=self.unittouu( self.options.week_width_str )
    ...
    def RenderMonthGrid(self, month, year):
        ...
        for week in range(self.numweeks):
            if week==0:
                ...
                line_atts = {'style': simplestyle.formatStyle(self.line_style),
                             'd': path
                            }
        ...
        while week_y < self.doc_h-self.pad:
            ...
            while i<7:
                ...
                if (i==1 or i==7): txt_atts['style']=simplestyle.formatStyle(self.style_weekend)
                ...
                if day==1 or very_first:
                    ...
                    inkex.etree.SubElement(self.month_g, 'text', txt_atts).text = self.options.month_names[month-1]
                    ...
                    inkex.etree.SubElement(self.month_g, 'text', txt_atts).text = str(day)
                    very_first = False
